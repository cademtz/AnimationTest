...
extern void Bitmap_Draw_Bits(BitmapHandle Bmp, int X, int Y, IntColor* Bits, int Width, int Height);
extern IntColor* Bitmap_CopyBits(BitmapHandle Bmp);
extern void Bitmap_FreeBits(IntColor* Bits);
